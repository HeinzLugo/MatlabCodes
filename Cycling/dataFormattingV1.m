% PROCESS for organizing data for analysis
% 1. Retrieve file data and make matrix with data from distance, speed, HR,
% Cadence, power and RPE.
% 2. Speed must be calculated from the distance information.
% 3. Divide data by kilometer. For RPE include the data for before and
% after test.
% 4. Divide data by time. For RPE include the data for before and
% after test.
% 5. Get average and standard deviation values for the divided data.
% 6. Graph the averaged data.
% 7. Store the organized data into a csv file for comparison.
% This function 
% Some preprocessing
% 1. Copy unix time to time.
% 2. Delete the latitude, longitude, Altitude, Temperature
% 3. Change No Data to 0
% 4. Eliminate the pre 0  values and data after 4 km
...
if testTypeSelection ~= 0
    ...
    if isequal(fileName,0)
        ...
        if testTypeSelection == 1
            ...
            resultDataByDistance = zeros(ceil(dataGarmin(indexRowDataGarminFormatted, indexDistance)), indexColumnResultByDistance);
        end
